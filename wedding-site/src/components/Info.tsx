    ...
    <section id="info" className="info fade-in" ref={fadeInRef}>
      ...
      <div className="info_grid">
        ...
        <div className="info_card">
          ...
          <h3>Traje</h3>
          <p>Sugerimos o traje <strong>Esporte Fino</strong>. Queremos que se sintam elegantes, mas acima de tudo, confortáveis para celebrar conosco do início ao fim!</p>
        </div>
        <div className="info_card">
